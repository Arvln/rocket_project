...
#郵箱驗證鏈接
EMAIL_VERIFY_URL = 'http://127.0.0.1:8000/api/email/verification/get/'
...
ALIPAY_RETURN_URL = 'http://127.0.0.1:80/api/payment/status/'

#定時器
CRONJOBS = [
    #每分鐘生成一次靜態文件
    ('*/1 * * * *', 'contents.crons.generate_static_index_html', '>> ' + str(BASE_DIR.parent / 'logs/crontab.log'))
]
CRONTAB_COMMAND_PREFIX = 'LANG_ALL=zh_TW.UTF-8'
...
CORS_ORIGIN_WHITELIST = [
    'http://192.168.126.130:80' ,
    'http://192.168.126.130:8000' ,
    'http://localhost:80' ,
    'http://localhost:8000' ,
    'http://www.rocketmall.gq:80' ,
    'http://www.rocketmall.gq:8000' ,
    'http://api.rocketmall.gq:80' ,
    'http://api.rocketmall.gq:8000' ,
]
...
#MySQL讀寫分離路由
DATABASE_ROUTERS = ['rocket_mall.utils.db_router.MasterSlaveDBRouter']
